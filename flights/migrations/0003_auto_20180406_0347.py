...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('flights', '0002_auto_20180325_1111'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_on', models.DateTimeField(default=datetime.datetime(2018, 4, 6, 3, 47, 35, 836700))),
        ...
        migrations.AddField(
            ...
            name='store',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cuelink_offers', to='flights.Store'),
        ),
    ]
