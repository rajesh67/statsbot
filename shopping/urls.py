...
urlpatterns=[
	...
	url('^h/(?P<storeName>[a-zA-Z0-9]+)/$', StoreDetailView.as_view(), name="store-homepage"),
	url('^h/(?P<storeName>[a-zA-Z0-9]+)/l/(?P<categoryName>[a-zA-Z0-9]+)/$', CategoryListView.as_view(), name="store-category"),
